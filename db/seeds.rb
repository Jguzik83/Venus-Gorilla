...
survey1 = Survey.create(title: 'Ice Cream', description: 'Ice cream is such a great dessert. We want to find out more about your interests and selections.', user_id: 1)

survey2 = Survey.create(title: 'Programming', description: 'Let us know your best practices for writing code.', user_id: 2)
